...
const TestimonialSlider = () => {
  ...
  return (
    ...
    <Box display="flex" alignItems="center" justifyContent="center" height="200px" sx={{backgroundColor: '#020617', color: 'white'}}>
      <AnimatePresence>
        <motion.div
          ...
          exit={{ opacity: 0 }}
          >
          <Typography variant="h6">{testimonials[index].text}</Typography>
