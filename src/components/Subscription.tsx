    ...
    <motion.div className="w-full max-w-[20rem] p-8 md:m-8 sm:mt-5 rounded-xl" style={{ background: 'linear-gradient(to right, #080a52, #0a0d6c)', transition: 'transform 0.3s' }}
      ...
      <div className="p-0">
        <List className="flex flex-col gap-4">
          <ListItem className="flex items-center gap-4">
            ...
            <ListItemText primary={<Typography className="font-normal" sx={{ color: 'white' }}>5 team members</Typography>} />
          </ListItem>
          <ListItem className="flex items-center gap-4">
            <span className="rounded-full border border-white/20 bg-white/20 p-1">
              <CheckIcon sx={{ color: 'white' }} />
            </span>
            <ListItemText primary={<Typography className="font-normal" sx={{ color: 'white' }}>200+ components</Typography>} />
          </ListItem>
          <ListItem className="flex items-center gap-4">
            <span className="rounded-full border border-white/20 bg-white/20 p-1">
              <CheckIcon sx={{ color: 'white' }} />
            </span>
            <ListItemText primary={<Typography className="font-normal" sx={{ color: 'white' }}>40+ built-in pages</Typography>} />
          </ListItem>
          <ListItem className="flex items-center gap-4">
            <span className="rounded-full border border-white/20 bg-white/20 p-1">
              <CheckIcon sx={{ color: 'white' }} />
            </span>
            <ListItemText primary={<Typography className="font-normal" sx={{ color: 'white' }}>1 year free updates</Typography>} />
          </ListItem>
          <ListItem className="flex items-center gap-4">
            <span className="rounded-full border border-white/20 bg-white/20 p-1">
              <CheckIcon sx={{ color: 'white' }} />
            </span>
            <ListItemText primary={<Typography className="font-normal" sx={{ color: 'white' }}>Life time technical support</Typography>} />
          </ListItem>
        </List>
      </div>
      <div className="mt-12 p-0">
        <Button variant="contained" size="large"
          ...
          fullWidth={true} onClick={handleClick}>
          Buy Now
        </Button>
      </div>
    </motion.div>
