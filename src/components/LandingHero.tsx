...
const LandingHero = () => {
  ...
  return (
    <>
      ...
      <div className="flex relative overflow-hidden my-5 ">
        ...
        <motion.div className="abosulte z-1 left-10 right-0  top-0 bottom-0 mx-auto " variants={imageVariants} initial="initial" animate="animate">
          <img
            src={'https://cdn.hashnode.com/res/hashnode/image/upload/v1702020251641/6a7b21f7-ab01-4f24-9633-31b350fe702c.png?auto=format,compress'}
            alt={`Image 2`}
        ...
        <motion.div className="absolute top-24 -right-10 z-10 " variants={imageVariants} initial="initial" animate="animate" whileTap={{ scale: 0.9 }}>
          <img
